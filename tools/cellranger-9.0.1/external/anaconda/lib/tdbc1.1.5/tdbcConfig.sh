...
# dir.
tdbc_LIB_SPEC="-Lexternal/anaconda/lib/tdbc1.1.5 -ltdbc1.1.5"
TDBC_LIB_SPEC="-Lexternal/anaconda/lib/tdbc1.1.5 -ltdbc1.1.5"
...
# String to pass to the linker to pick up the TDBC stub library from its
# installed directory
tdbc_STUB_LIB_SPEC="-Lexternal/anaconda/lib/tdbc1.1.5 -ltdbcstub1.1.5"
TDBC_STUB_LIB_SPEC="-Lexternal/anaconda/lib/tdbc1.1.5 -ltdbcstub1.1.5"
...
tdbc_STUB_LIB_PATH="external/anaconda/lib/tdbc1.1.5/libtdbcstub1.1.5.a"
TDBC_STUB_LIB_PATH="external/anaconda/lib/tdbc1.1.5/libtdbcstub1.1.5.a"
...
# headers
tdbc_INCLUDE_SPEC="-Iexternal/anaconda/include"
TDBC_INCLUDE_SPEC="-Iexternal/anaconda/include"
...
tdbc_LIBRARY_PATH="external/anaconda/lib/tdbc1.1.5"
TDBC_LIBRARY_PATH="external/anaconda/lib/tdbc1.1.5"
